...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['action']) && $_POST['action'] == "RemoveNTariffVer") {

        $GUID = $_POST['Ver_GUID'];
        $route = $Tariff_Obj->D_NTariffVersion_ByID($GUID);
        if (!empty($route)  ) {
                    ...
                    <div class="col-sm-12">
                        <div class="panel panel-default card-view">
                            <div class="panel-heading">
                                ...
                                <div class="panel-heading">
                                    <div class="pull-left">
                                        <h6 class="panel-title txt-dark"> فهرست نسخ تعرفه ها </h6>
                                    </div>
                                                            ...
                                                            echo '<td><div class="dropdown">
		                                                    	    <a class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
		                                                    	    	...
		                                                    	    	<ul class="dropdown-menu" data-dropdown-in="bounceIn" data-dropdown-out="bounceOut" style="background-color: #efefef;">
		                                                    	    		<li>
		                                                    	    		<form method="post" enctype="multipart/form-data" action="U_NTariffVersion.php">
		                                                    	    			<input type="hidden" name="Ver_GUID" value="' . $row['GUID'] . '">
		                                                    	    			<input type="hidden" name="action" value="EditNTariffVer">
		                                                    	    		...
		                                                    	    		<li>
		                                                    	    			<form method="post" enctype="multipart/form-data">
		                                                    	    				<input type="hidden" name="Ver_GUID" value="' . $row['GUID'] . '">
		                                                    	    				<input type="hidden" name="action" value="RemoveNTariffVer">
