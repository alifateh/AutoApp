...
<body>
					...
					<div class="col-sm-12">
						<div class="panel panel-default card-view">
							<div class="panel-heading">
								...
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark"> تعریف نام خودروساز </h6>
									</div>
										...
										<div id="example-basic">
											<div class="col-sm-6">
												...
												<div class="form-group">
													<label class="control-label mb-10" for="exampleInputuname_1"> نام خودروساز : </label>
													<div class="input-group col-sm-6">
														<div class="input-group-addon"><i class="icon-info"></i></div>
														<input type="text" class="form-control" name="manName" id="manName" placeholder="نام خودروساز" value="<?php echo $_POST['manName'] ;?>" >
													</div>
												</div>
												<br>
												<div class="form-group mb-30">
													<label class="control-label mb-10 text-left"> تصویر لوگوی خودروساز : </label>
												...
												<br />
												<div class="form-group">
													<button class="btn btn-info btn-anim" type="submit" name="manufacturREG" id="manufacturREG"><i class="icon-check"></i><span class="btn-text">ثبت</span></button>
	...
	if (isset($_POST['manufacturREG'])) {
		$autobj = new auto($_SESSION["Admin_GUID"]);

		if (file_exists($_FILES['fileToUpload']['tmp_name']) || is_uploaded_file($_FILES['fileToUpload']['tmp_name'])) {

			$target_dir = "images/manufacturelogo/";
			...
			if ($uploadOk == 0) {
				...
				if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $FileMove)) {
					...
					//add with file
					$autobj->C_Manufacture($_POST['manName'], $fileName, $FileMove);
				} else {
					echo '<script language="javascript">';
					echo "$(document).ready(function() {
								$('body').removeAttr('class').removeClass('bottom-center-fullwidth').addClass('top-center-fullwidth');
			...
			//add wit no file
			$autobj->C_Manufacture($_POST['manName'], "", $FileMove);
		}
	}
