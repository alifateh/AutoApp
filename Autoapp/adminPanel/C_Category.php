...
if (isset($_POST['login-btn']) && $_POST['catname'] !== "") {
	$cat = new cat($_SESSION["Admin_GUID"]);
	$catname = $_POST['catname'];
	$cat->C_Category($catname);
}
					...
					<div class="col-sm-12">
						<div class="panel panel-default card-view">
							<div class="panel-heading">
								...
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark"> تعریف رسته </h6>
									</div>
										...
										<div id="example-basic">
											<div class="col-sm-6">
												...
												<div class="form-group">
													<label class="control-label mb-10" for="exampleInputuname_1"> نام رسته : </label>
													<div class="input-group col-sm-6">
														<div class="input-group-addon"><i class="icon-info"></i></div>
														<input type="text" class="form-control" name="catname" id="catname" value="<?php echo $_POST['catname'] ;?>">
													</div>
												</div>
												<br>
												<br>
