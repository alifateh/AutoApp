...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $post_ServiceName_FA = $_POST['servicename_Fa'];
    $post_ServiceName_EN = $_POST['servicename_En'];
    $Error_STR =0;

    if (empty($post_autotariff) || empty($post_ServiceName_FA) || empty($post_ServiceName_EN)) {
        $Error_STR = 2;
    } else {
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group col-sm-6">
                                                        <label class="control-label" for="exampleInputuname_1"> نام فارسی سرویس : </label>
                                                        <div class="input-group ">
                                                            <div class="input-group-addon"><i class="icon-info"></i></div>
                                                            <input type="text" class="form-control" name="servicename_Fa" id="servicename_Fa" value="<?php echo $_POST['servicename_Fa'] ;?>">
                                                        </div>
                                                        <br />
                                                    </div>

                                                    <div class="input-group col-sm-6">
                                                        <label class="control-label" for="exampleInputuname_1"> نام انگلیسی سرویس : </label>
                                                        <div class="input-group ">
                                                            <div class="input-group-addon"><i class="icon-info"></i></div>
                                                            <input type="text" class="form-control" name="servicename_En" id="servicename_En" value="<?php echo $_POST['servicename_En'] ;?>">
                                                        </div>
                                                        <br />
                                                    </div>
                                                    ...
                                                    <div class="panel-wrapper collapse in">
                                                        <div class="panel-body">
                                                            <div class="row mt-40">
                                                                <div class="col-sm-12">
                                                                    <div class="form-group">
                                                                        <label class="control-label mb-10" for="exampleInputuname_1"> این سرویس مختص خودروهای موجود در انواع تعرفه های زیر است </label>
                                                                        <br />
                                                                        <select multiple id="optgroup" name="optgroup[]" multiple='multiple'>
                                                                            ...
                                                                            if (!empty($TariffAllTypes)) {
                                                                                ...
                                                                                echo '<option value=""> انواع تعرفه تعیین نشده است </option>';
                                                                            }
