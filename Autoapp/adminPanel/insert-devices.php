...
<body>
											...
											<form method="post" enctype="multipart/form-data">
												...
												<div class="form-group">
													...
													<div class="input-group">
														...
														<input type="text" class="form-control" name="devicename" id="devicename" placeholder="نام دستگاه">
													</div>
												</div>
												<br>
												<div class="form-group">
													<label class="control-label mb-10 text-left"> کلمات کلیدی : </label>
													<textarea class="form-control" rows="3" name="devicetag" id="devicetag" placeholder="کلمات کلیدی"></textarea>
												</div>

												<div class="form-group mb-30">
													<label class="control-label mb-10 text-left"> مستندات دستگاه : </label>
												...
												<br />
												<div class="form-group">
													<button class="btn btn-info btn-anim" type="submit" name="devicereg" id="devicereg"><i class="icon-check"></i><span class="btn-text">ثبت</span></button>
	...
	if (isset($_POST['devicereg']) && $_POST['devicename'] !== "") {
		$sdevice = new dev($_SESSION["Admin_GUID"]);
		...
		if (file_exists($_FILES['fileToUpload']['tmp_name']) || is_uploaded_file($_FILES['fileToUpload']['tmp_name'])) {
			...
			if ($uploadOk == 0) {
				...
				if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
					...
					$sdevice->adddevice($_POST['devicename'], $_POST['devicetag'], $target_file);
				} else {
					echo '<script language="javascript">';
					echo "$(document).ready(function() {
								$('body').removeAttr('class').removeClass('bottom-center-fullwidth').addClass('top-center-fullwidth');
			...
			$sdevice->adddevice($_POST['devicename'], $_POST['devicetag'], "");
		}
	}
