...
header("Location: $url");
	...
	require('config/tcpdf_include.php');
	require('config/phpqrcode/qrlib.php');
...
//############################################################################################
    ...
    $urlRelativeFilePath = 'https://portal.autoapp.ir/config/phpqrcode/temp/'.$fileName;
