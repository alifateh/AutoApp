...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['Insert'])) {
        ...
        if (file_exists($_FILES['fileToUpload']['tmp_name']) || is_uploaded_file($_FILES['fileToUpload']['tmp_name'])) {
            ...
            $target_dir = "images/A_D_V/MainSlides/";
            ...
            if ($uploadOk != 0) {
                if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
                    ...
                    if (!in_array($Error_STR, $ER)) {
                        $route = $Slide_Obj->C_Slider($N_Slogn, $N_Link, $target_file, $Position);
                    }
                } else {
                    $Error_STR = 1;
                }
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <div class="input-group col-sm-6">
                                                        <label class="control-label mb-10" for="P_Position"> محل نصب اسلاید : </label>
                                                        <div class="input-group col-sm-6">
                                                            <div class="input-group-addon"><i class="icon-info"></i></div>
                                                            <input type="Number" class="form-control" name="P_Position" id="P_Position" min="0" max="10" value="<?php echo $_POST['P_Position']; ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                <br />
                                                ...
                                                <br />
                                                <div class="form-group">
                                                    <label class="control-label mb-10" for="P_Link"> آدرس لینک اسلاید : </label>
                                                    <div class="input-group col-sm-6">
                                                        <div class="input-group-addon"><i class="icon-info"></i></div>
                                                ...
                                                <br />
                                                <div class="form-group">
                                                    <label class="control-label mb-10 text-left"> تصویر جدید اسلاید : </label>
