...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    /// form values
    //
    if (!empty($_POST['TariffType_Fa']) && !empty($_POST['TariffType_En']) && !empty($_POST['optgroup'])) {
        ...
        if (!empty($post_MechanicTariff)) {
            foreach ($post_MechanicTariff as $key) {
                $route = $Tariff_Obj->C_Service($key, $post_TariffTypeFa, $post_TariffTypeEn);
            }
        } else {
            $route = 0;
        }
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group col-sm-6">
                                                        ...
                                                        <input type="text" class="form-control" name="TariffType_Fa" id="TariffType_Fa" value ="<?php echo $_POST['TariffType_Fa']; ?>" >
                                                    </div>
                                                </div>
                                                <br>
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group col-sm-6">
                                                        <div class="input-group-addon"><i class="icon-info"></i></div>
                                                        <input type="text" class="form-control" name="TariffType_En" id="TariffType_En" value ="<?php echo $_POST['TariffType_En']; ?>">
                                                    </div>
                                                </div>
                                                <br>
                                                <div class="form-group">
                                                    <label class="control-label mb-10" for="optgroup"> فهرست انواع تعرفه ها : </label>
                                                    <div class="input-group col-sm-6">
