...
require("$rootDir/config/phpqrcode/qrlib.php");
...
$pdf->SetCreator("Fatehchehr");
$pdf->SetAuthor('Fatehchehr');
$pdf->SetTitle('تحت نظارت اتحادیه صنف تعمیرکاران خودرو تهران');
$pdf->SetSubject('نرخ نامه');
$pdf->SetKeywords('نرخ نامه اتحادیه , PDF');
...
$pdf->Output($auto_name . '-' . $get_TariffVer[0]['NameFa'] . '.pdf', 'I');
