...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $post_tariffFA = $_POST['TariffType_Fa'];
    $post_tariffEN = $_POST['TariffType_En'];
    $Error_STR = 0;

    if (!empty($post_tariffFA) && !empty($post_tariffEN)) {

        $route = $Tariff_Obj->C_TariffType($post_tariffFA, $post_tariffEN);
                    ...
                    <div class="col-sm-12">
                        <div class="panel panel-default card-view">
                            <div class="panel-heading">
                                ...
                                <div class="panel-heading">
                                    <div class="pull-left">
                                        <h6 class="panel-title txt-dark"> تعیین نوع تعرفه </h6>
                                    </div>
