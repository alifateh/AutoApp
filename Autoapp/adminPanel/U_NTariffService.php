...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($_POST['action'] == "EditNServices") {
        ...
        $Service = $Tariff_Obj->Get_NService_ByID($ServiceGUID);
        if (empty($Service)) {
            // return VALUES
    ...
    if ($_POST['action'] !== "EditNServices") {
        ...
        $Tariff_Obj = new NewTariff($_SESSION["Admin_GUID"]);
        $get_SRV = $Tariff_Obj->Get_NService_ByID($ServiceGUID);
        ...
        $route = $Tariff_Obj->U_NTariff_Services($ServiceGUID, $ServiceTypeFA, $ServiceTypeEN);
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control" name="NSRV_Fa" id="NSRV_Fa" placeholder="<?php echo $Service[0]['NameFa']; ?>" value="<?php echo $_POST['NSRV_Fa']; ?>">
                                                            </div>
                                                        </div>
                                                        <br>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                <div class="input-group-addon"><i class="icon-info"></i></div>
                                                                <input type="text" class="form-control" name="NSRV_En" id="NSRV_En" placeholder="<?php echo $Service[0]['NameEn']; ?>" value="<?php echo $_POST['NSRV_En']; ?>">
                                                            </div>
                                                        </div>
                                                        <br>
                                                        <div class="form-group">
