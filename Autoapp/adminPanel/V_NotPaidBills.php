...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $bill = $V_Invoce->V_NotPaidBills($TarrifID);
} else {
    $tariffver = new Ntariff($_SESSION["Admin_GUID"]);
    $V_Invoce = new invoice($_SESSION["Admin_GUID"]);
    $mem = new member($_SESSION["Admin_GUID"]);
                    ...
                    <div class="col-sm-12">
                        <div class="panel panel-default card-view">
                            <div class="panel-heading">
                                ...
                                <div class="panel-heading">
                                    <div class="pull-left">
                                        <h6 class="panel-title txt-dark"> فهرست عدم پرداختی ها </h6>
                                    </div>
                                            ...
                                            <table id="datable_1" class="table table-hover display  pb-30">
                                                ...
                                                <tbody>
                                                    ...
                                                    if (!empty($bill)) {
                                                        ...
                                                        echo '<tr><td colspan="3" style="text-align: center;"> همگی صورت حساب های این دوره پرداخت شده است </td></tr>';
                                                    }
