...
$data = $Tariff_Obj->V_NTariffArchive();
                    ...
                    <div class="col-sm-12">
                        <div class="panel panel-default card-view">
                            <div class="panel-heading">
                                ...
                                <div class="panel-heading">
                                    <div class="pull-left">
                                        <h6 class="panel-title txt-dark"> فهرست آرشیو تعرفه ها </h6>
                                    </div>
		                                                    			...
		                                                    			<a class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
		                                                    				...
		                                                    				<ul class="dropdown-menu" data-dropdown-in="bounceIn" data-dropdown-out="bounceOut" style="background-color: #efefef;">
		                                                    					...
		                                                    					<li>
		                                                    					 ...
		                                                    					 <li>
		                                                    						<form method="post" enctype="multipart/form-data" action="V_NTariffAll.php">
		                                                    							 <input type="hidden" name="NTariffGUID" value="' . $row['GUID'] . '">
                                                                                ...
                                                                                <li>
		                                                    						<form method="post" enctype="multipart/form-data">
		                                                    							...
		                                                    							<button style ="border:none;" onclick="return removevalidation()"><i class="icon-pencil"></i> افزایش درصدی </button>
		                                                    						</form>
		                                                    					</li>
		                                                    					<li class="divider"></li>
		                                                    					<li>
