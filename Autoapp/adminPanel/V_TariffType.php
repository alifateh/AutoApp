...
$V_Tariff = $Tariff_Obj->V_TariffTypes();
$Error_STR = 0;
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['action'])) {
        if ($_POST['action'] == "RemoveNTariff") {
            $GUID = $_POST['Tariff_GUID'];
            $route = $Tariff_Obj->D_TariffType_ByID($GUID);
            if (!empty($route)  ) {
                                            ...
                                            <table id="datable_1" class="table table-hover display  pb-30">
                                                ...
                                                <tbody>
                                                    ...
                                                    if (!empty($V_Tariff)) {
                                                            ...
                                                            echo '<div class="dropdown">
		                                                    	    <a class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
		                                                    	    	...
		                                                    	    	<ul class="dropdown-menu" data-dropdown-in="bounceIn" data-dropdown-out="bounceOut" style="background-color: #efefef;">
		                                                    	    		<li>
		                                                    	    		<form method="post" enctype="multipart/form-data" action="U_TariffType.php">
		                                                    	    			<input type="hidden" name="Tariff_GUID" value="' . $row['GUID'] . '">
		                                                    	    			<input type="hidden" name="action" value="EditNTariff">
                                                        ...
                                                        echo '<tr><td colspan="3" style="text-align: center;"> انواع تعرفه ها تعیین نشده </td></tr>';
                                                    }
