...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $post_Text = $_POST['Doc_Comments'];
    $Error_STR = 0;

    if (file_exists($_FILES['fileToUpload']['tmp_name']) || is_uploaded_file($_FILES['fileToUpload']['tmp_name'])) {

        $target_dir = "MechanicDocuments/";
        ...
        if ($uploadOk != 0) {
            if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
                ...
                //add with file
                $Doc_Obj->C_MechanicDOC($post_Title, $post_Text, $target_file);
            } else {
                $Error_STR = 1;
            }
        }
                    ...
                    <div class="col-sm-12">
                        <div class="panel panel-default card-view">
                            <div class="panel-heading">
                                ...
                                <div class="panel-heading">
                                    <div class="pull-left">
                                        <h6 class="panel-title txt-dark"> تعریف مستندات : </h6>
                                    </div>
                                        ...
                                        <div id="example-basic">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="control-label mb-10" for="Doc_Title"><i class="text-info mb-10">*</i> موضوع : </label>
                                                    <div class="input-group col-sm-6">
                                                        <div class="input-group-addon"><i class="icon-info"></i></div>
                                                        <input type="text" class="form-control" name="Doc_Title" id="Doc_Title" value="<?php echo $_POST['Doc_Title']; ?>">
                                                    </div>
                                                </div>
                                                <br>
                                                <div class="form-group">
                                                    <label class="control-label mb-10" for="Doc_Comments"><i class="text-info mb-10">*</i> شرح : </label>
                                                    <div class="input-group col-sm-6">
                                                        <div class="input-group-addon"><i class="icon-info"></i></div>
                                                        <input type="text" class="form-control" name="Doc_Comments" id="Doc_Comments" value="<?php echo $_POST['Doc_Comments']; ?>">
                                                    </div>
                                                </div>
                                                <br>
                                                <div class="form-group">
                                                    <label class="control-label mb-10 text-left"> فایل : </label>
