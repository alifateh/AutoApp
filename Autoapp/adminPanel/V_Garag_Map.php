...
if (isset($_SESSION["GUID"])) {
  $map = $Garage_obj->Get_LocationMap_ByID($_SESSION['GUID']);
} elseif(isset($_POST['GarageGUID'])){
  $map = $Garage_obj->Get_LocationMap_ByID($_POST['GarageGUID']);
}else {
  session_unset();
  session_write_close();
  $url = "./sysAdmin.php";
...
<body>
  <div id="map" style="font-family: 'Fatehchehr'; height : 640px;"></div>
  <script>
