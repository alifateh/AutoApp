...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!isset($_POST['action']) && isset($_POST['Increase'])) {
        $value = $_POST['Increase'];
        $TariffGUID = $_POST['TariffGUID'];
        $route = $Tariff_Obj -> U_TariffValue_ByTariffID ($TariffGUID, $value);
        if ($route !== 1){
            $Error_STR = 2;
        }
    }
                                        ...
                                        <div id="example-basic">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="control-label mb-10" for="Increase"> درصد افزایش اجرت ها : </label>
                                                    <div class="input-group col-sm-6">
                                                        <div class="input-group-addon"><i class="icon-info"></i></div>
                                                        <input type="hidden" name="TariffGUID" id="TariffGUID" value="<?php echo $NTariffGUID;?>">
                                                        <input type="number" class="form-control" onkeypress="return onlyNumberKey(event)" name="Increase" id="Increase" placeholder="درصد افزایش" value="<?php echo $_POST['Increase'] ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group">
